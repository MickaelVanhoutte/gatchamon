...
export const POKEDEX: PokemonTemplate[] = [
  ...
  // --- Thunder Spire enemies ---
  {
    id: 81,
    name: 'Magnemite',
    types: ['electric'],
    naturalStars: 1,
    spriteUrl: 'sprites/81.png',
