...
export const ITEM_DUNGEONS: ItemDungeonDef[] = [
  {
    ...
    floors: [
      ...
      { enemyLevel: 25, enemies: [75, 95, 74], drops: [
  ...
  },
  {
    ...
    floors: [
      ...
      { enemyLevel: 25, enemies: [69, 43, 44], drops: [
  ...
  },
  {
    ...
    floors: [
      ...
      { enemyLevel: 25, enemies: [100, 81, 25], drops: [
  ...
  },
  {
    ...
    floors: [
      ...
      { enemyLevel: 25, enemies: [124, 87, 91], drops: [
  ...
  },
  {
    ...
    floors: [
      ...
      { enemyLevel: 25, enemies: [130, 147, 148], drops: [
