...
export const FORMS: PokemonTemplate[] = [
  ...
  // ── Silvally forms (fused Typenull) ──────────────────────────────────
  // Stats sit between a 4★ and 5★; power budget is spent in the skill tree.
  {
    id: 15990,
    name: 'Silvally-Fire',
    types: ['fire'],
    naturalStars: 5,
    spriteUrl: 'monsters/ani/silvally-fire.gif',
    skillIds: ['homunculus_fire_basic', 'homunculus_fire_s2_1a', 'homunculus_fire_p_1a'],
    height: 2.3,
    summonable: false,
    baseStats: {
      hp: 580,
  ...
  },
  {
    ...
    naturalStars: 5,
    spriteUrl: 'monsters/ani/silvally-water.gif',
    skillIds: ['homunculus_water_basic', 'homunculus_water_s2_1a', 'homunculus_water_p_1a'],
    height: 2.3,
    summonable: false,
    baseStats: {
      hp: 580,
  ...
  },
  {
    ...
    naturalStars: 5,
    spriteUrl: 'monsters/ani/silvally-grass.gif',
    skillIds: ['homunculus_grass_basic', 'homunculus_grass_s2_1a', 'homunculus_grass_p_1a'],
    height: 2.3,
    summonable: false,
    baseStats: {
      hp: 580,
  ...
  },
  {
    ...
    naturalStars: 5,
    spriteUrl: 'monsters/ani/silvally-psychic.gif',
    skillIds: ['homunculus_psychic_basic', 'homunculus_psychic_s2_1a', 'homunculus_psychic_p_1a'],
    height: 2.3,
    summonable: false,
    baseStats: {
      hp: 580,
  ...
  },
  {
    ...
    naturalStars: 5,
    spriteUrl: 'monsters/ani/silvally-dark.gif',
    skillIds: ['homunculus_dark_basic', 'homunculus_dark_s2_1a', 'homunculus_dark_p_1a'],
    height: 2.3,
    summonable: false,
    baseStats: {
      hp: 580,
