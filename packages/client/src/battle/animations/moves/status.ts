...
const BUFF_MOVES = [
	...
	'agility', 'rock-polish', 'shell-smash', 'quiver-dance', 'coil',
	'hone-claws', 'work-up', 'curse', 'shift-gear', 'cotton-guard',
	'iron-defense', 'acid-armor', 'barrier', 'amnesia', 'cosmic-power',
	'defend-order', 'stockpile', 'double-team', 'autotomize', 'charge',
	'focus-energy', 'meditate', 'sharpen', 'acupressure', 'geomancy',
	'extreme-evoboost', 'switcheroo', 'tailwind', 'mirror-move',
	'mud-sport', 'rototiller', 'copycat', 'camouflage', 'helping-hand',
	'splash', 'psych-up', 'sleep-talk', 'bestow', 'pain-split',
	'assist', 'metronome', 'recycle', 'follow-me', 'mimic',
...
const DEBUFF_MOVES = [
	'growl', 'leer', 'tail-whip', 'string-shot', 'sand-attack',
	'smokescreen', 'flash', 'kinesis', 'sweet-scent', 'scary-face',
	'cotton-spore', 'fake-tears', 'metal-sound', 'screech', 'charm',
	'feather-dance', 'captivate', 'memento', 'parting-shot', 'noble-roar',
	'play-nice', 'baby-doll-eyes', 'tearful-look', 'tickle',
	'venom-drench', 'quash', 'roar'
];

const HEAL_MOVES = [
	'recover', 'soft-boiled', 'milk-drink', 'slack-off', 'roost',
	'moonlight', 'morning-sun', 'synthesis', 'wish', 'heal-order',
	'shore-up', 'rest', 'aqua-ring', 'ingrain', 'leech-seed',
	'strength-sap', 'life-dew', 'floral-healing', 'heal-pulse',
	'pollen-puff', 'jungle-healing', 'aromatherapy', 'refresh',
	'swallow', 'healing-wish'
];

const STATUS_CONDITION_MOVES = [
	'thunder-wave', 'stun-spore', 'glare', 'nuzzle', 'zap-cannon',
	'will-o-wisp', 'toxic', 'poison-powder', 'poison-gas',
	'sleep-powder', 'hypnosis', 'sing', 'lovely-kiss', 'grass-whistle',
	'spore', 'yawn', 'dark-void', 'confuse-ray', 'supersonic',
	'swagger', 'flatter', 'teeter-dance', 'attract', 'encore',
	'taunt', 'torment', 'disable', 'spite', 'grudge', 'destiny-bond',
	'perish-song', 'sweet-kiss', 'nightmare', 'spider-web', 'block',
	'mean-look'
];
...
const PROTECT_MOVES = [
	...
	'max-guard', 'crafty-shield', 'mat-block', 'light-screen',
	'reflect', 'aurora-veil', 'safeguard', 'mist', 'substitute',
	'magic-coat'
];

const WHIP_MOVES = ['branch-poke', 'bind', 'constrict', 'wrap', 'vine-whip', 'power-whip'];

BUFF_MOVES.forEach((move) => { statusMoves[move] = buffAnimation; });
DEBUFF_MOVES.forEach((move) => { statusMoves[move] = debuffAnimation; });
HEAL_MOVES.forEach((move) => { statusMoves[move] = healAnimation; });
STATUS_CONDITION_MOVES.forEach((move) => { statusMoves[move] = statusConditionAnimation; });
